#!/usr/bin/env bash
# Replication run 3-D: SMQR (anchor-only, sc_tau_res_scale=0.0), seed=3, 20k iters.
#
# Same offline dataset & preset as the seed=1 baseline (exp_08_smqr).
# Output directory will be renamed to  logs/hv-g1-manager/exp_09_smqr_seed3/
#
# Usage
# -----
#   bash scripts/train_replication/train_smqr_seed3.sh
