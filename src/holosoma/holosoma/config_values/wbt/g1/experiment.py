...
g1_29dof_wbt_cql = ExperimentConfig(
    ...
    algo=replace(
        ...
        config=replace(
            ...
            risk_lambda=  0.02,
            risk_learning_rate=1.0e-4,
            risk_cost_beta= 0.5,
            risk_bad_tracking_terminal_cost= 6.0,
            risk_motion_ends_bootstrap= False,
            risk_root_pos_weight= 2.5,
            risk_root_ori_weight= 1.5,
            risk_body_pos_weight= 2.0,
