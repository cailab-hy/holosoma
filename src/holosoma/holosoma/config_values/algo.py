...
cql = CQLAlgoConfig(
    ...
    config=CQLConfig(
        ...
        cql_temperature=1.0,
        cql_weight=5.0,
        use_boundary_proposal=True,
        boundary_num_action_samples=2,
        boundary_eps=0.01,
        boundary_noise_scale=0.005,
        boundary_sparse_dims=3,
        boundary_focus_mu=0.02,
        boundary_focus_sigma=0.02,
        boundary_focus_scale=0.25,
        use_actor_bc_reg=False,
        actor_bc_weight=0.0,
        actor_bc_loss_type="mse",
        actor_bc_warmup_only=False,
        actor_bc_decay_steps=0,
        target_entropy_ratio=0.0,
        risk_mode="neutral",
        cvar_alpha=0.1,
        num_atoms=101,
