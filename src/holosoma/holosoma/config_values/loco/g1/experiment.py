...
g1_29dof_offline_sac = ExperimentConfig(
    env_class="holosoma.envs.locomotion.locomotion_manager.LeggedRobotLocomotionManager",
    training=TrainingConfig(project="hv-g1-manager", name="g1_29dof_cql_weight_5_manager"),
    algo=replace(algo.cql, config=replace(algo.cql.config, num_learning_iterations=50000, use_symmetry=True, cql_weight=5,cql_num_action_samples=10)),
    simulator=simulator.isaacgym,
    robot=robot.g1_29dof,
    terrain=terrain.terrain_locomotion_mix,
    observation=observation.g1_29dof_loco_single_wolinvel,
...
__all__ = ["g1_29dof", "g1_29dof_fast_sac", "g1_29dof_fast_sac_data","g1_29dof_offline_sac"]
