...
def save_params(
    ...
    save_dict = {
        ...
        "actor_target_state_dict": cpu_state(actor_target.state_dict()),
    ...
    if metadata is None:
        raise ValueError("Checkpoint metadata is required when saving TD3+BC parameters.")
